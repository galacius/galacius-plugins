...
Security vulnerabilities in Galacius plugins should be reported responsibly and confidentially. We appreciate your help in keeping the project secure.

### Primary Reporting Channel

Please use GitHub's private vulnerability reporting feature for the `galacius/galacius-plugins` repository:

1. Go to the [Security tab](https://github.com/galacius/galacius-plugins/security) on the repository
...
Thank you for helping to keep Galacius and its plugins secure!
